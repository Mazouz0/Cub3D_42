...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   bonus_textures_colors2.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: alamini <alamini@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/24 17:52:47 by alamini           #+#    #+#             */
/*   Updated: 2025/01/21 18:23:07 by alamini          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_texture(char *identifier, char *line, t_gdata *game)
{
	...
	while (*tmp == ' ')
		tmp ++;
	path = ft_malloc(ex_strlen(tmp), 0);
	if (!path)
	...
	if (fd == -1)
		ft_clean(NULL, "Invalid texture path");
...
int	get_color(char *identifier, char *str, t_gdata *game)
{
	...
	if (fill_rgb(game, dbl_ptr, identifier))
		ft_clean(NULL, "Invalid Flor-Ceiling RGB");
	return (0);
}
