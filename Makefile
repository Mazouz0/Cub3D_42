SRC_FILES = 	src/main.c \
				...
				src/parse/map.c src/parse/map2.c src/exec/animation.c\
				gnl/get_next_line.c gnl/get_next_line_utils.c \
				utils/utils.c utils/ft_split.c utils/utils2.c utils/special_utils.c \
				src/exec/init_funcs.c src/exec/exec.c src/exec/ray_casting.c src/exec/player_utils.c \
				src/exec/utils_1.c src/exec/utils_2.c src/exec/draw.c src/exec/player_hooks.c src/exec/draw_utils.c \
				src/exec/put_textures.c src/parse/textures_utils.c src/exec/animation_utils.c src/exec/open_dors.c \
